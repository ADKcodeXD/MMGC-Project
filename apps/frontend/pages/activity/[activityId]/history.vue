<template>
  <div class="flex flex-col items-center w-full relative">
    <div class="line"></div>
    <p class="absolute text-light-50 right-3/4 text-3xl top-1 mr-4">To Be Continue.....</p>
    <div class="w-4/5 relative overflow-auto max-h-[calc(100vh-250px)]" ref="historyList">
      <div
    ...
    <Transition name="up-to-down" mode="out-in">
      <div
        class="absolute bottom-[-20px] left-1/2 transform -translate-x-1/2 text-light-50"
...
const strictLength = (htmlStr: string) => {
  return htmlStr && htmlStr.length > DESC_LENGTH
    ? `${htmlStr.slice(0, DESC_LENGTH)}...`
    : htmlStr.slice(0, DESC_LENGTH) || '暂无介绍'
}
