...
export interface ActivityVo extends Omit<ActivityModel, 'staff' | 'sponsorId'> {
  /**
   * StaffVo类型
   */
  staff: StaffVo | null
...
export type ActivityParamsTemp = Partial<
  Pick<
    ActivityModel,
...
export interface ActivityParams extends ActivityParamsTemp {
  /**
   * 活动组织人员 id集合类型
   */
  staff: Staff | null
...
export interface ActivityUpdateParams extends Partial<Omit<ActivityParams, 'activityId'>> {
  /**
   * 必填 更新需要携带活动id
   */
  activityId: number
